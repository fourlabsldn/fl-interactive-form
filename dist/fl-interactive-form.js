...
var FormUI = function (_ReactBEM) {
  ...
  FormUI.prototype.generateInitialState = function generateInitialState() {
    ...
    ui.questions = this.props.config.questions.map(function (q) {
...
var Form = function (_ReactBEM) {
  ...
  Form.prototype.generateInitialState = function generateInitialState() {
    ...
    try {
      for (var _iterator = _getIterator(config.questions), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
        var q = _step.value;
  ...
  Form.prototype.setQuestionResponse = function setQuestionResponse(questionKey, answerValue) {
    ...
    var qIndex = this.state.config.questions.findIndex(function (q) {
      return q.key === questionKey;
    });
    assert(qIndex !== -1, 'Did not find question with key: ' + questionKey);
